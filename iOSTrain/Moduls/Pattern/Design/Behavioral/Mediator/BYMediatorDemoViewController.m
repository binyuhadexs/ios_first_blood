//
//  BYMediatorDemoViewController.m
//  iOSTrain
//
...
#import "BYMediatorDemoViewController.h"
#import "Colleague.h"
...
@interface BYMediatorDemoViewController ()

@property (nonatomic,strong) OneMediator *mediator;

@end

@implementation BYMediatorDemoViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    
    self.mediator = [OneMediator new];
